...
<body>
	<div class="w-100 border border-0 border-bottom border-top bg-light d-inline-block">
	    ...
	    <div class="border-start float-end">
	        <button class="small ui button blue m-2" onclick="window.location.href='/SpringMVCHibernate/admin/login/page'">Admin</button>
	    </div>
	</div>
	<div class="row g-0">
	    ...
	    <div class="col-lg-8 col-12 text-center">
	            ...
	            <div id="carousels" class="carousel slide" data-bs-ride="carousel">
	                ...
	                <div class="carousel-inner">
	                    <div class="carousel-item active" data-bs-interval="5000">
	                        <img src="<c:url value='/resources/images/Slide1.PNG'/>" class="d-block w-100">
	                    ...
	                    <div class="carousel-item" data-bs-interval="5000">
	                        <img src="<c:url value='/resources/images/Slide2.PNG'/>" class="d-block w-100">
	                        <div class="carousel-caption d-none d-md-block">
	                    ...
	                    <div class="carousel-item" data-bs-interval="5000">
	                        <img src="<c:url value='/resources/images/Slide3.PNG'/>" class="d-block w-100">
	                        <div class="carousel-caption d-none d-md-block">
	        ...
	        <div class="border border-top-0 p-2 bg-light">
	            <button class="small ui right labeled icon button purple" onclick="window.location.href='/SpringMVCHibernate/user/filters/page'">
		            <i class="search icon"></i>
		            Packages
	            </button>
	            <button class="small ui right labeled icon button violet" onclick="window.location.href='/SpringMVCHibernate/user/agencies/page'">
		            <i class="search icon"></i>
		            Agencies
	            </button>
	        </div>
